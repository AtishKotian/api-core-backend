...
router.patch("/:empId/updateEmployeeStatus", verifySession, EmployeeController.deactivateEmployeeStatus);
router.patch("/reactivate/:empId", verifySession, EmployeeController.updateEmployeeStatus);
